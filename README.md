...
This repository contains the gRPC Protobuf contracts for communication between the Java Hub and Python Classifier
microservices.
...
The `classifier/v1/classifier.proto` file defines the gRPC service for audio classification between the Java Hub and
Python Classifier.
...
**Do not modify existing fields.** To introduce breaking changes, create a new `v2/` directory following the same
structure.